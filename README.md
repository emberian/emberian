i did many things to help ship [rust](https://github.com/rust-lang/rust/) 1.0 and help launch the [mina](https://github.com/minaprotocol/mina) zero-knowledge distributed proof system.
